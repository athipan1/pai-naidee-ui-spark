...
### การทดสอบ Python 3.12 🐍

#### การทดสอบ Local สำหรับ Python 3.12

สำหรับการทดสอบ Python dependencies ที่อัปเดตใหม่เพื่อรองรับ Python 3.12:
...
4. **ทดสอบการ import numpy**:
```bash
python -c "import numpy; print(f'numpy version: {numpy.__version__}')"
```

5. **รันแอปพลิเคชันเพื่อตรวจสอบการทำงาน**:
```bash
python -c "import pandas, numpy, fastapi; print('✅ All packages imported successfully')"
```

#### การ Deploy บน Vercel (Python 3.12)

สร้างไฟล์ `vercel.json` เพื่อระบุ Python 3.12 runtime:
...
#### ทางเลือกสำหรับ Python 3.11

หากต้องการใช้ Python 3.11 แทน ให้อัปเดต `vercel.json`:
...
และสามารถคงเวอร์ชัน numpy ที่ 1.25.2 ได้
