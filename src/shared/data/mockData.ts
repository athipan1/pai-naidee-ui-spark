...
export const mockAttractions: SearchResult[] = [
  ...
  },
  {
    ...
    description: 'Traditional floating market where vendors sell fresh fruits, local food, and handicrafts from boats.',
    confidence: 0.89,
...
export const mockSearch = async (query: string): Promise<SearchResponse> => {
  ...
  const filteredResults = mockAttractions.filter(attraction =>
