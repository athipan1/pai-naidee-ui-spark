...
export const mockLocations: Location[] = [
  ...
  },
  {
    ...
    name: "Patong Beach",
    nameLocal: "หาดป่าตอง",
    aliases: ["ป่าตอง", "patong", "หาดป่าตอง"],
    province: "Phuket",
    provinceLocal: "ภูเก็ต",
    region: "South",
    category: "Beaches",
    tags: ["Beach", "Nightlife", "Shopping", "Water Sports", "Restaurants"],
    geo: { lat: 7.89306, lng: 98.29833 },
    popularityScore: 0.96,
    description: "Phuket's most famous beach, known for its vibrant nightlife, shopping, and wide range of water activities.",
    descriptionLocal: "หาดป่าตองเป็นหนึ่งในสถานที่ท่องเที่ยวยอดนิยมของจังหวัดภูเก็ต ที่ดึงดูดนักท่องเที่ยวทั้งชาวไทยและต่างชาติด้วยบรรยากาศที่หลากหลายและมีชีวิตชีวา"
  }
];
...
export const mockAttractions: SearchResult[] = [
  ...
  },
  {
    ...
    image: "/src/shared/assets/hero-beach.jpg",
    description:
      "Phuket's most famous and lively beach resort, offering a 3-kilometer stretch of sand, extensive nightlife, shopping, and numerous water sports.",
    confidence: 0.96,
    matchedTerms: ["beach", "patong", "phuket", "nightlife"],
    amenities: ["Restaurants", "Nightlife", "Shopping", "Water Sports", "Beach Access"],
    location: { lat: 7.89306, lng: 98.29833 },
  },
];
...
export const mockAttractionDetails = {
  ...
  "6": {
    ...
    description: "Phuket's most famous and lively beach resort, offering a 3-kilometer stretch of sand, extensive nightlife, shopping, and numerous water sports.",
    descriptionLocal: "หาดป่าตองเป็นหนึ่งในสถานที่ท่องเที่ยวยอดนิยมของจังหวัดภูเก็ต ที่ดึงดูดนักท่องเที่ยวทั้งชาวไทยและต่างชาติด้วยบรรยากาศที่หลากหลายและมีชีวิตชีวา 🌴🌊\n\n🏖️ หาดป่าตอง: จุดเด่นและกิจกรรม\n\n• ชายหาดยาวประมาณ 3 กิโลเมตร ทอดขนานไปกับทะเลอันดามัน น้ำทะเลใส ทรายขาวละเอียด เหมาะสำหรับการพักผ่อน เล่นน้ำ และชมวิวพระอาทิตย์ตก\n• กิจกรรมทางน้ำ เช่น เจ็ตสกี บานาน่าโบ๊ท พาราเซลลิ่ง ดำน้ำตื้น และดำน้ำลึก เหมาะสำหรับผู้ที่ชื่นชอบความตื่นเต้น\n• สถานบันเทิงยามค่ำคืน ถนนบางลา (Bangla Walking Street) เป็นแหล่งรวมบาร์ ไนต์คลับ และโชว์ต่าง ๆ ที่คึกคักตลอดคืน\n• แหล่งช้อปปิ้งและร้านอาหาร เช่น ห้างจังซีลอน Central Patong และตลาดนัด Malin Plaza ที่มีอาหารท้องถิ่นและของฝากมากมาย\n\n🛕 สถานที่ใกล้เคียงที่น่าสนใจ\n\n• วัดสุวรรณคีรีวงก์ (วัดป่าตอง) วัดเก่าแก่ที่มีสถาปัตยกรรมไทยผสมจีน และพระมหาธาตุเจดีย์สีทองอร่าม เหมาะสำหรับสายบุญที่ต้องการเสริมสิริมงคล\n• Paradise Beach และหาดไตรตรัง เป็นชายหาดที่เงียบสงบกว่า เหมาะสำหรับการพักผ่อนแบบส่วนตัว\n\nหากคุณต้องการสัมผัสทั้งธรรมชาติ ความสนุก และวัฒนธรรมในที่เดียว หาดป่าตองคือคำตอบที่ลงตัวที่สุดในภูเก็ตเลยครับ",
    tags: ["Beach", "Nightlife", "Shopping", "Water Sports", "Restaurants"],
    location: { lat: 7.89306, lng: 98.29833 },
    amenities: ["Restaurants", "Nightlife", "Shopping", "Water Sports", "Beach Access", "Parking", "Restrooms"],
     externalLinks: {
      officialWebsite: "https://www.phuket.com/island/patong.htm",
      wikipediaUrl: "https://en.wikipedia.org/wiki/Patong"
    },
  }
};
