  ...
  const faqItems: AccordionItemData[] = [
    {
      ...
      content: 'Pai Nai Dee is a comprehensive travel platform for discovering amazing destinations in Thailand.'
    },
    {
      id: 'faq-2',
      title: 'How do I book attractions?',
      content: 'You can book attractions directly through our platform by selecting your preferred dates and following the booking process.'
    },
    {
      id: 'faq-3',
      title: 'Are there group discounts available?',
      content: 'Yes, we offer special group discounts for bookings of 5 or more people. Contact our support team for more details.'
    }
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Enhanced Accordion Component</h1>
      ...
      <section className="space-y-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="basic-1">
            ...
            <AccordionContent>
              An accordion is a vertically stacked list of items, such as labels or thumbnails, 
              where each item can be expanded or collapsed to reveal additional content.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="basic-2">
            <AccordionTrigger>Why use accordions?</AccordionTrigger>
            <AccordionContent>
              Accordions help organize content in a space-efficient way, allowing users to 
              focus on specific sections while keeping other content accessible.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
        ...
        >
          <AccordionItem value="multi-1">
            ...
            <AccordionContent>
              ...
              This is useful for comparing content or viewing multiple sections at once.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="multi-2">
            <AccordionTrigger>Feature 2: Callback Support</AccordionTrigger>
            <AccordionContent>
              The enhanced accordion supports onValueChange, onOpen, and onClose callbacks.
              Check the browser console to see these callbacks in action.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="multi-3">
            <AccordionTrigger>Feature 3: Styled Variants</AccordionTrigger>
            <AccordionContent>
              This accordion uses the &apos;outlined&apos; variant, which provides a more prominent border.
              Other variants include &apos;default&apos; and &apos;ghost&apos;.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
          ...
          <div>
            ...
            <Accordion type="single" size="sm" collapsible>
              <AccordionItem value="size-sm">
                ...
                <AccordionContent>
                  This is a small-sized accordion with reduced padding and text size.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div>
            ...
            <Accordion type="single" size="lg" collapsible>
              <AccordionItem value="size-lg">
                ...
                <AccordionContent>
                  This is a large-sized accordion with increased padding and text size.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-medium mb-2">Custom Icon (Plus/Minus)</h3>
            <Accordion type="single" collapsible>
          ...
          <div>
            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="icon-left">
                ...
                <AccordionContent>
                  The icon can be positioned on either the left or right side of the trigger.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div>
            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="icon-hidden">
                ...
                <AccordionContent>
                  Sometimes you might want a cleaner look without any expansion indicator icon.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
        ...
        <Accordion type="single" variant="ghost" collapsible>
          <AccordionItem value="ghost-1">
            ...
            <AccordionContent>
              ...
              perfect for cleaner layouts or when the accordion is used within other containers.
            </AccordionContent>
          </AccordionItem>
      ...
      <div className="text-center text-sm text-muted-foreground mt-8">
        <p>Open the browser console to see callback logs when interacting with accordions that have callbacks enabled.</p>
      </div>
    </div>
  );
};
