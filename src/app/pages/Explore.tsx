...
import { ArrowLeft, Search, Plus, Heart, MessageCircle, Share, Bookmark, MoreVertical, Play, Pause } from 'lucide-react';
...
const Explore = ({ currentLanguage, onBack }: ExploreProps) => {
  ...
  const handleLike = (postId: string) => {
    setVideoPosts(posts => posts.map(post => 
      post.id === postId 
        ? { 
            ...post, 
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4 px-6">
          ...
          <div>
            <p className="text-lg font-medium text-foreground mb-2">{t.noVideos}</p>
            ...
            <div className="absolute inset-0 z-20 flex">
              ...
              <div className="flex-1 flex flex-col justify-end p-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center text-white/90">
                    <span className="text-sm">{post.location}, {post.province}</span>
                  </div>
                  
                  {/* Hashtags */}
                  <div className="flex flex-wrap gap-2">
                    {post.hashtags.map((tag, idx) => (
                      <span key={idx} className="text-accent-yellow text-sm font-medium">
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              <div className="w-16 flex flex-col justify-end items-center space-y-6 p-4">
                ...
                <div className="flex flex-col items-center space-y-1">
                  ...
                  <span className="text-white text-xs">{formatNumber(post.likes)}</span>
                </div>
                ...
                <div className="flex flex-col items-center space-y-1">
                  ...
                  <span className="text-white text-xs">{formatNumber(post.comments)}</span>
                </div>
                ...
                <div className="flex flex-col items-center space-y-1">
                  ...
                  <span className="text-white text-xs">{formatNumber(post.shares)}</span>
                </div>
