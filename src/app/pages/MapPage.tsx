...
const MapPage = ({ currentLanguage, onBack }: MapPageProps) => {
  ...
  const currentAttraction = attractions.find(a => a.id === id) || attractions[0];
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <p className="text-xl text-muted-foreground">ไม่พบสถานที่</p>
  ...
  return (
    <div className={`${isFullScreen ? "fixed inset-0 z-50" : "min-h-screen"} bg-background`}>
      ...
      <div className="flex flex-col lg:flex-row h-full">
        {/* Filters Sidebar */}
        {showFilters && (
          <div className="w-full lg:w-80 bg-background border-r p-4 space-y-6">
            <Card>
              <CardHeader>
        ...
        <div className="flex-1 relative">
          ...
          <div className={`${isFullScreen ? "h-screen" : "h-96 lg:h-screen"} w-full bg-gradient-to-br from-blue-50 to-green-50 border rounded-lg overflow-hidden relative`}>
