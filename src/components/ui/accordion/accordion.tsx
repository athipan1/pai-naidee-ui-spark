 ...
 */
const getAnimationClasses = (animationType: AccordionAnimationType, duration: number) => {
...
>(({ 
  ...
  const icon = customIcon || <ChevronDown className="h-4 w-4 shrink-0 transition-transform duration-200" />;
